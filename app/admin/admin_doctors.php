                            ...
                            <?php foreach ($doctors as $doctor): ?>
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <a class="btn btn-sm btn-danger" href="admin_doctor_delete.php?id=<?php echo (int)$doctor['doctor_id']; ?>" onclick="return confirm('Delete this doctor? This will also remove linked schedules and appointments.');">Delete</a>
                                    </td>
                                </tr>
                            <?php endforeach; ?>
                        <?php else: ?>
